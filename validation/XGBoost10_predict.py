...
if __name__ == '__main__':
    ...
    model10 = pickle.load(open("model10.pickle.dat", "rb"))  # load model with best performance
    ...
    for id in range(7445, 8268):
        ...
        for col in range(10, 11):  # to skip Charttime
...
np.save("output10", evaluate_result)
