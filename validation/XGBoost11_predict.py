...
if __name__ == '__main__':
    ...
    model11 = pickle.load(open("model11.pickle.dat", "rb"))  # load model with best performance
    ...
    for id in range(7445, 8268):
        ...
        for col in range(11, 12):  # to skip Charttime
...
np.save("output11", evaluate_result)
