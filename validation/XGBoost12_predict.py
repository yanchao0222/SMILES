...
if __name__ == '__main__':
    ...
    model12 = pickle.load(open("model12.pickle.dat", "rb"))  # load model with best performance
    ...
    for id in range(7445, 8268):
        ...
        for col in range(12, 13):  # to skip Charttime
...
np.save("output12", evaluate_result)
