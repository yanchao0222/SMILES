...
if __name__ == '__main__':
    ...
    model13 = pickle.load(open("model13.pickle.dat", "rb"))  # load model with best performance
    ...
    for id in range(7445, 8268):
        ...
        for col in range(13, 14):  # to skip Charttime
...
np.save("output13", evaluate_result)
